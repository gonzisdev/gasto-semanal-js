...
class UI {
    ...
    agregarGastoListado(gastos) {
        ...
        gastos.forEach(gasto => {
            ...
            nuevoGasto.dataset.id = id; // dataset agrega "data-" y luego le sigue lo que tu pongas
    ...
    e.preventDefault();
     ...
     if(nombre === '' || cantidad === '') {
          ...
          ui.imprimirAlerta('Cantidad no válida', 'error')
            ...
            const gasto = { nombre, cantidad, id: Date.now() }; // lo contrario a un destructuring Object literal enhancement
